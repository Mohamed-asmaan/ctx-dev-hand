...
This repository follows the [IBM Hackathon GitHub Project Template](https://github.com/watsonxhackathon/ibm-hackathon-template).
...
**ctx note:** this engine is local. Core commands do not read `IBM_CLOUD_API_KEY`. Do not add a real key unless you introduce IBM Cloud calls yourself.
...
- [IBM Hackathon template](https://github.com/watsonxhackathon/ibm-hackathon-template)
